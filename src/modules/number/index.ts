...
export class NumberModule extends SimpleModuleBase {
  ...
  int(
    ...
    return numberInt(fakerToCore(this.faker), options);
  }
  ...
  float(
    ...
    return numberFloat(fakerToCore(this.faker), options);
  }
  ...
  binary(
    ...
    return numberBinary(fakerToCore(this.faker), options);
  }
  ...
  octal(
    ...
    return numberOctal(fakerToCore(this.faker), options);
  }
  ...
  hex(
    ...
    return numberHex(fakerToCore(this.faker), options);
  }
  ...
  bigInt(
    ...
    return numberBigInt(fakerToCore(this.faker), options);
  }
  ...
  romanNumeral(
    ...
    return numberRomanNumeral(fakerToCore(this.faker), options);
  }
}
