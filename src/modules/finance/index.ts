...
export class FinanceModule extends ModuleBase {
   ...
   *
   * @see faker.currency.code(): For generating specifically the currency code.
   * @see faker.currency.name(): For generating specifically the currency name.
   * @see faker.currency.symbol(): For generating specifically the currency symbol.
   * @see faker.currency.numericCode(): For generating specifically the currency numeric code.
   *
   * @example
