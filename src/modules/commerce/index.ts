...
export class CommerceModule extends ModuleBase {
   ...
   */
  department(): string {
    return commerceDepartment(fakerToCore(this.faker));
  }
   ...
   */
  productName(): string {
    return commerceProductName(fakerToCore(this.faker));
  }
  ...
  price(
    ...
    return commercePrice(fakerToCore(this.faker), options);
  }
  ...
  productAdjective(): string {
    return commerceProductAdjective(fakerToCore(this.faker));
  }
  ...
  productMaterial(): string {
    return commerceProductMaterial(fakerToCore(this.faker));
  }
   ...
   */
  product(): string {
    return commerceProduct(fakerToCore(this.faker));
  }
  ...
  productDescription(): string {
    return commerceProductDescription(fakerToCore(this.faker));
  }
  ...
  isbn(
    ...
    return commerceIsbn(fakerToCore(this.faker), options);
  }
  ...
  upc(
    ...
    return commerceUpc(fakerToCore(this.faker), options);
  }
}
