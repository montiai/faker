...
export class SystemModule extends ModuleBase {
  ...
  fileName(
    ...
    return systemFileName(fakerToCore(this.faker), options);
  }
  ...
  commonFileName(extension?: string): string {
    return systemCommonFileName(fakerToCore(this.faker), extension);
  }
   ...
   */
  mimeType(): string {
    return systemMimeType(fakerToCore(this.faker));
  }
  ...
  commonFileType(): string {
    return systemCommonFileType(fakerToCore(this.faker));
  }
  ...
  commonFileExt(): string {
    return systemCommonFileExt(fakerToCore(this.faker));
  }
   ...
   */
  fileType(): string {
    return systemFileType(fakerToCore(this.faker));
  }
  ...
  fileExt(mimeType?: string): string {
    return systemFileExt(fakerToCore(this.faker), mimeType);
  }
  ...
  directoryPath(): string {
    return systemDirectoryPath(fakerToCore(this.faker));
  }
   ...
   */
  filePath(): string {
    return systemFilePath(fakerToCore(this.faker));
  }
   ...
   */
  semver(): string {
    return systemSemver(fakerToCore(this.faker));
  }
  ...
  networkInterface(
    ...
    return systemNetworkInterface(fakerToCore(this.faker), options);
  }
  ...
  cron(
    ...
    return systemCron(fakerToCore(this.faker), options);
  }
}
